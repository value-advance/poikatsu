...
(function () {
  ...
  const PR_OFFERS = [
    ...
    { title: "マツキヨココカラオンラインストア 店舗と共通ポイント", type: "ドラッグストア通販", points: "1,980円以上", suffix: "の注文で送料無料", category: "shopping", tags: ["beginner"], url: "/pages/articles/matsukiyo-cocokara-online-toha", img: "https://www27.a8.net/svt/bgt?aid=260720103870&wid=002&eno=01&mid=s00000026754001004000&mc=1" },
  ...
  const POPULAR_ARTICLES = [
    ...
    { title: "マツキヨココカラオンラインストアとは?送料無料条件・支払い方法・当日配送を解説", excerpt: "マツモトキヨシ・ココカラファインの公式通販の特徴、送料無料の条件、支払い方法、当日配送サービスまでわかりやすく解説します。", url: "/pages/articles/matsukiyo-cocokara-online-toha", thumbType: "summary", category: "shopping" },
    ...
    { title: "エアトリポイントの使い道は?貯め方・有効期限をわかりやすく解説", excerpt: "エアトリポイントの貯め方・使い道・1ポイントの価値・有効期限を公式情報をもとに解説します。", url: "/pages/articles/airtrip-poikatsu", thumbType: "compare", category: "campaign" },
    ...
    { title: "au PAYふるさと納税のPontaポイントは貯まる?2025年10月の変更を解説", excerpt: "2025年10月からのPontaポイント加算終了と、現在の使い方・還元の考え方を解説します。", url: "/pages/articles/aupay-furusato-poikatsu", thumbType: "beginner", category: "seikatsu" },
  ...
  const ARTICLE_SEARCH_INDEX = [
    ...
    { title: "Apple Payでポイ活する方法!ポイント還元とiD・QUICPay・タッチ決済の違い", url: "/pages/articles/apple-pay-poikatsu", category: "クレジットカード", date: "2026.09.06", thumbType: "creditcard", excerpt: "Apple Pay自体にはポイント制度がなく、実際のポイントは登録したカードで決まる仕組みを解説。iD・QUICPay・タッチ決済の違い、レジでの選び方、Suicaとの混同に注意する点も紹介します。" },
    { title: "保険相談案件のポイ活とは?面談前に知っておきたいメリットと注意点", url: "/pages/articles/hoken-soudan-anken-poikatsu", category: "ポイントサイト", date: "2026.09.06", thumbType: "caution", excerpt: "保険相談案件のポイ活について、対象になる条件や面談実施・アンケート回答などの成果条件の違い、却下されやすいケース、面談前後に確認したいことを初心者向けに解説します。" },
    { title: "楽天銀行ハッピープログラムの基本!銀行取引で楽天ポイントを貯める方法", url: "/pages/articles/rakuten-ginkou-happy-program", category: "口座開設", date: "2026.09.06", thumbType: "summary", excerpt: "楽天銀行「ハッピープログラム」の仕組みを解説。給与受取・口座振替などポイント対象取引、会員ステージの判定条件、マネーブリッジとの違いを公式情報にもとづいて紹介します。" },
    { title: "格安SIM乗り換えでポイ活する方法!通信費を下げながら得する流れ", url: "/pages/articles/kakuyasu-sim-norikae-poikatsu", category: "キャンペーン", date: "2026.09.05", thumbType: "campaign", excerpt: "格安SIM・オンライン専用プランへの乗り換えでポイ活する方法を解説。MNPキャンペーンの条件確認、初期費用、年間コスト比較、乗り換え前の注意点まで初心者向けに紹介します。" },
    { title: "ポイントサイトで却下される原因は?承認条件の読み方を初心者向けに解説", url: "/pages/articles/pointsite-kyakka-genin", category: "ポイントサイト", date: "2026.09.05", thumbType: "caution", excerpt: "ポイントサイト経由でポイントが却下される主な原因、成果条件の読み方、Cookie・広告ブロックの影響、証拠の残し方まで初心者向けに解説します。" },
    { title: "楽天トラベルスーパーSALE攻略|エントリー条件とクーポン併用ルール", url: "/pages/articles/rakuten-travel-supersale-entry-coupon", category: "キャンペーン", date: "2026.09.05", thumbType: "campaign", excerpt: "2026年9月開催の楽天トラベルスーパーSALEについて、エントリーが必要なキャンペーン、クーポンとポイントの併用条件、通常予約との違いを公式情報にもとづいて解説します。" },
    { title: "ポイ活サービスを退会する前に確認すること!ポイント失効を防ぐ手順", url: "/pages/articles/poikatsu-taikai-mae-kakunin", category: "ポイントサイト", date: "2026.09.05", thumbType: "beginner", excerpt: "ポイ活サービスを退会する前に確認したい保有残高・交換可能額・未承認ポイントの扱い、メール配信停止との違い、退会後に記録を残すコツを初心者向けに解説します。" },
    ...
    { title: "利回りくんとは?不動産クラウドファンディングの特徴とリスクを解説", url: "/pages/articles/rimawarikun-toha", category: "生活", date: "2026.09.03", thumbType: "caution", excerpt: "1口1万円から始められる不動産クラウドファンディング「利回りくん」の特徴、想定利回り、リスク、利用前に確認したいポイントをわかりやすく解説します。" },
    { title: "ひかりTVとは?特徴と料金プランをわかりやすく解説", url: "/pages/articles/hikaritv-toha", category: "生活", date: "2026.09.03", thumbType: "summary", excerpt: "テレビ・ビデオ・カラオケなどが楽しめる「ひかりTV」の特徴、料金プラン、対応デバイス、dポイントとの関係をわかりやすく解説します。" },
    { title: "dカーシェアとは?特徴とdポイントの貯め方をわかりやすく解説", url: "/pages/articles/dcarshare-toha", category: "生活", date: "2026.09.03", thumbType: "summary", excerpt: "複数のカーシェア・レンタカーを1つのIDで使える「dカーシェア」の特徴、料金の考え方、dポイントとの関係をわかりやすく解説します。" },
    { title: "dマガジンとは?月額料金と読める雑誌数をわかりやすく解説", url: "/pages/articles/dmagazine-toha", category: "生活", date: "2026.09.03", thumbType: "summary", excerpt: "2,400誌以上が読み放題の「dマガジン」の月額料金、読み放題の仕組み、dポイント特典をわかりやすく解説します。" },
    { title: "あんしんセキュリティとは?月額料金と機能をわかりやすく解説", url: "/pages/articles/anshin-security-toha", category: "生活", date: "2026.09.03", thumbType: "summary", excerpt: "迷惑電話・危険サイト対策などが月額550円で使える「あんしんセキュリティ」の特徴、機能、対応デバイスをわかりやすく解説します。" },
    { title: "dヘルスケアとは?歩数・体重記録でdポイントが貯まる仕組みを解説", url: "/pages/articles/dhealthcare-toha", category: "生活", date: "2026.09.03", thumbType: "summary", excerpt: "歩数・体重の記録でdポイントが貯まる「dヘルスケア」の特徴、月額料金、無料お試し期間をわかりやすく解説します。" },
    { title: "dフォトとは?毎月フォトブックが届くサービスをわかりやすく解説", url: "/pages/articles/dphoto-toha", category: "生活", date: "2026.09.03", thumbType: "summary", excerpt: "スマホの写真から毎月フォトブックが届く「dフォト」の特徴、月額料金、繰り越し制度をわかりやすく解説します。" },
    { title: "dヒッツとは?月額300円からの音楽聴き放題サービスを解説", url: "/pages/articles/dhits-toha", category: "生活", date: "2026.09.03", thumbType: "summary", excerpt: "月額300円・500円のプランで楽しめる音楽配信サービス「dヒッツ」の特徴、プログラム再生の仕組み、料金プランをわかりやすく解説します。" },
    { title: "ahamoとは?月額料金とdポイントの貯め方をわかりやすく解説", url: "/pages/articles/ahamo-toha", category: "生活", date: "2026.09.03", thumbType: "summary", excerpt: "月額2,970円で30GB使えるドコモのオンライン専用プラン「ahamo」の料金プラン、通話条件、dポイントとの関係をわかりやすく解説します。" },
    { title: "docomo selectとは?スマホアクセサリー購入とdポイントを解説", url: "/pages/articles/docomo-select-toha", category: "ショッピング", date: "2026.09.03", thumbType: "summary", excerpt: "スマホ・タブレット用アクセサリーが揃う「docomo select」の特徴、dポイントの貯め方・使い方、送料の考え方をわかりやすく解説します。" },
    { title: "Leminoプレミアムとは?月額料金とdポイント還元をわかりやすく解説", url: "/pages/articles/lemino-premium-toha", category: "生活", date: "2026.09.03", thumbType: "summary", excerpt: "約180,000本のコンテンツが楽しめる「Leminoプレミアム」の月額料金、独占配信作品、dポイント還元をわかりやすく解説します。" },
    ...
    { title: "ポイント投資・ポイント運用を主要サービスで比較", url: "/pages/articles/point-toushi-unyou-service-hikaku", category: "ショッピング", date: "2026.09.03", thumbType: "compare", excerpt: "マネックス証券・楽天証券・PayPay証券・SBI証券などのポイント投資・ポイント運用サービスを比較。最低ポイントや投資対象、メリットと損をする可能性を初心者向けに解説します。" },
    { title: "ポイントが貯まる銀行を比較!d・楽天・V・Ponta・PayPay系の選び方", url: "/pages/articles/point-tamaru-ginkou-hikaku", category: "口座開設", date: "2026.09.03", thumbType: "compare", excerpt: "dポイント・楽天ポイント・Vポイント・Pontaポイント・PayPayポイントが貯まる主要ネット銀行を比較。対象取引、還元・上限、証券連携から自分に合う銀行の選び方を解説します。" },
    ...
    { title: "マツキヨココカラのポイント制度!マツキヨココカラポイントとdポイントの関係", url: "/pages/articles/matsukiyo-cocokara-point", category: "ショッピング", date: "2026.09.02", thumbType: "compare", excerpt: "現金払いとクレジット払いでの違い、dポイントとの併用条件を解説します。" },
    ...
    { title: "マツキヨココカラでポイ活する方法!アプリ・クーポン・決済の基本", url: "/pages/articles/matsukiyo-cocokara-poikatsu", category: "ショッピング", date: "2026.09.02", thumbType: "earnings", excerpt: "公式アプリ会員の確認、クーポンの入手・使い方、支払い方法の選び方、日用品購入で活用するコツを解説します。" },
    ...
    { title: "家電量販店のポイント比較|還元率・現金値引き・支払い方法を7社で比較", url: "/pages/articles/kadenryohanten-point-hikaku", category: "ショッピング", date: "2026.09.05", thumbType: "compare", excerpt: "ヨドバシ・ビックカメラ・ヤマダ・エディオン・ジョーシン・ノジマ・ケーズデンキのポイント制度を7社で比較。還元率だけでなく、現金値引きや支払い方法による違いを公式情報をもとに整理し、実質的なお得さがわかります。" },
    ...
    { title: "百貨店のポイントを比較!高島屋・三越伊勢丹・大丸松坂屋など", url: "/pages/articles/hyakkaten-depart-poikatsu", category: "ショッピング", date: "2026.07.12", thumbType: "beginner", excerpt: "高島屋・三越伊勢丹・大丸松坂屋・そごう西武・阪急阪神など主要百貨店のポイント制度を比較。基本の貯め方、百貨店系カード、友の会の違いを解説します。" },
    ...
    { title: "スタバのポイント「Star」はどう貯まる?貯め方・交換先・有効期限を解説", url: "/pages/articles/starbucks-poikatsu", category: "ショッピング", date: "2026.07.12", thumbType: "app", excerpt: "Starは60円(税込)で1つ貯まります。貯め方・交換先・有効期限、PayPay・Apple Pay払い時の注意点をわかりやすく解説します。" },
    ...
    { title: "本・電子書籍のポイ活方法!主要ストアのポイント還元率を比較", url: "/pages/articles/hon-denshi-shoseki-poikatsu", category: "ショッピング", date: "2026.07.12", thumbType: "compare", excerpt: "楽天ブックス・楽天Kobo・hontoなど主要ストアのポイント還元率を比較。通常還元とキャンペーンの違いをわかりやすく解説します。" },
    ...
    { title: "月初・月末のポイ活ルーティン!キャンペーンと失効をまとめて確認する方法", url: "/pages/articles/tsukihatsu-tsukimatsu-poikatsu-routine", category: "ポイントサイト", date: "2026.09.06", thumbType: "summary", excerpt: "月初に確認したいキャンペーン・エントリー状況と、月末に確認したい失効が近いポイント・期間限定ポイント・クーポンを10分のチェックリストで整理します。" },
