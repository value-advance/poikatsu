...
(function () {
  ...
  const RANKING_DATA = {
    sougou: [
      ...
      { title: "無料会員登録だけでポイントプレゼント", type: "無料登録", points: "2,000", suffix: "pts." },
      { title: "サンプル会員登録で今すぐポイント獲得", type: "無料登録", points: "500", suffix: "pts." },
    ...
    muryo: [
      ...
      { title: "資料請求だけで無料ポイントプレゼント", type: "無料登録", points: "800", suffix: "pts." },
      { title: "会員証発行無料登録キャンペーン", type: "無料登録", points: "700", suffix: "pts." },
      { title: "サンプルSNSフォロー&登録で無料ポイント", type: "無料登録", points: "600", suffix: "pts." },
      { title: "無料メルマガ登録でポイント進呈", type: "無料登録", points: "500", suffix: "pts." },
      { title: "サンプル比較サイト無料相談登録", type: "無料登録", points: "400", suffix: "pts." },
    ...
    creca: [
      ...
      { title: "家族カード追加発行でポイント進呈", type: "新規カード発行", points: "25,000", suffix: "pts." },
      { title: "サンプルゴールドカード新規入会", type: "新規カード発行", points: "20,000", suffix: "pts." },
      { title: "学生専用カード発行キャンペーン", type: "新規カード発行", points: "15,000", suffix: "pts." },
      { title: "法人カード新規発行で獲得", type: "新規カード発行", points: "12,000", suffix: "pts." },
      { title: "リボ払い登録+カード発行", type: "新規カード発行", points: "10,000", suffix: "pts." },
    ...
    kouza: [
      ...
      { title: "NISA口座開設キャンペーン", type: "新規口座開設", points: "15,000", suffix: "pts." },
      { title: "投資信託口座開設で獲得", type: "新規口座開設", points: "12,000", suffix: "pts." },
      { title: "外貨預金口座開設キャンペーン", type: "新規口座開設", points: "10,000", suffix: "pts." },
      { title: "サンプル信用金庫口座開設", type: "新規口座開設", points: "8,000", suffix: "pts." },
      { title: "ネット銀行口座開設&給与振込設定", type: "新規口座開設", points: "7,000", suffix: "pts." },
    ...
    kaimono: [
      ...
      { title: "サンプルスーパー買い物でポイント還元", type: "お買い物", points: "800", suffix: "pts." },
      { title: "ネットスーパー初回購入でポイント進呈", type: "お買い物", points: "700", suffix: "pts." },
      { title: "家電量販店ご利用でポイント還元", type: "お買い物", points: "600", suffix: "pts." },
      { title: "サンプルコスメ購入でポイント進呈", type: "お買い物", points: "500", suffix: "pts." },
      { title: "サンプル飲食予約サービス利用で獲得", type: "お買い物", points: "400", suffix: "pts." },
  ...
  // 記事下部の「関連する案件」表示用データ
  // 分類(category、1つ) … creditcard(クレジットカード) / kouza(口座開設) / shopping(ショッピング) /
  //                        app(アプリ案件) / survey(アンケート) / campaign(キャンペーン) /
  //                        furima(フリマ・オークション) / sidejob(副業) / pointsite(ポイントサイト)
  ...
  // TODO: 実際の案件が決まり次第、内容を差し替え・追加する
  const PR_OFFERS = [
    { title: "楽天カード 新規発行&利用で獲得", type: "クレジットカード", points: "8,000", suffix: "pts.", category: "creditcard", tags: ["rakuten"] },
    { title: "dカード 新規入会+利用で獲得", type: "クレジットカード", points: "6,000", suffix: "pts.", category: "creditcard", tags: ["dpoint"] },
    { title: "PayPayカード 新規発行で獲得", type: "クレジットカード", points: "5,000", suffix: "pts.", category: "creditcard", tags: ["paypay"] },
    { title: "au PAY カード 新規発行で獲得", type: "クレジットカード", points: "5,000", suffix: "pts.", category: "creditcard", tags: ["ponta"] },
    { title: "楽天モバイル 新規契約+利用で獲得", type: "キャンペーン", points: "10,000", suffix: "pts.", category: "campaign", tags: ["rakuten"] },
    { title: "ドコモ(ahamo)新規契約で獲得", type: "キャンペーン", points: "7,000", suffix: "pts.", category: "campaign", tags: ["dpoint"] },
    { title: "ソフトバンク/ワイモバイル 新規契約で獲得", type: "キャンペーン", points: "6,000", suffix: "pts.", category: "campaign", tags: ["paypay"] },
    { title: "au/UQ mobile 新規契約で獲得", type: "キャンペーン", points: "6,000", suffix: "pts.", category: "campaign", tags: ["ponta"] },
  ];
  ...
  function initRelatedOffers() {
    ...
    const matches = PR_OFFERS.filter((offer) =>
      offer.category === category || offer.tags.some((t) => tags.includes(t))
    );
  ...
  const ARTICLE_SEARCH_INDEX = [
    ...
    { title: "ポイントサイトとは?情報メディアとの違いと利用時の注意点", url: "/pages/articles/pointsite-toha.html", category: "ポイントサイト", date: "2026.07.12", thumbType: "beginner", excerpt: "ポイントサイトの基本や情報メディアとの違い、安全な使い方を解説します。" },
    { title: "A8.netのポイントNGとは?ポイ活記事で注意したい広告掲載ルール", url: "/pages/articles/a8net-point-ng.html", category: "ポイントサイト", date: "2026.07.12", thumbType: "caution", excerpt: "ポイントNGの意味やポイントサイト掲載との違い、安全な記事作成の考え方を解説します。" },
    { title: "ポイ活記事で避けたい表現まとめ!広告掲載ルールに配慮した書き方", url: "/pages/articles/poikatsu-kiji-hyogen-chuui.html", category: "ポイントサイト", date: "2026.07.12", thumbType: "caution", excerpt: "避けたい誘導表現やポイント付与と誤解される文言、読者に誠実な書き方を解説します。" },
    { title: "ポイ活サイトの信頼性を高める方法!運営者情報・引用・更新日の整え方", url: "/pages/articles/poikatsu-site-shinraisei.html", category: "ポイントサイト", date: "2026.07.12", thumbType: "summary", excerpt: "信頼されるサイトの条件や運営者情報の必要性、誤情報を防ぐチェックを解説します。" },
    { title: "ポイ活記事の比較表の作り方!読者にわかりやすいポイント整理術", url: "/pages/articles/poikatsu-hikakuhyou-tsukurikata.html", category: "ポイントサイト", date: "2026.07.12", thumbType: "compare", excerpt: "比較表に入れる項目や還元率だけで比べない理由、見やすい表の作成を解説します。" },
    { title: "ポイ活サイトでロゴを使う時の注意点!商標・公式素材・代替表現を解説", url: "/pages/articles/poikatsu-logo-chuui.html", category: "ポイントサイト", date: "2026.07.12", thumbType: "caution", excerpt: "ロゴを勝手に使わない理由や公式素材の確認方法、商標表記の注意点を解説します。" },
    ...
    { title: "ポイ活記事のキーワード選定方法!初心者向けサイトで狙いやすいテーマ", url: "/pages/articles/poikatsu-kiji-keyword-sentei.html", category: "ポイントサイト", date: "2026.07.14", thumbType: "summary", excerpt: "ポイ活記事のキーワード選定の基本や、初心者向け語句の探し方、サービス名と悩みを組み合わせるコツ、重複記事を避ける考え方、記事化の優先順位の付け方まで、サイト運営初心者に向けて順を追ってわかりやすく解説します。" },
    { title: "ポイ活記事の検索意図を分ける方法!比較・使い方・注意点を整理する", url: "/pages/articles/poikatsu-kiji-kensaku-ito.html", category: "ポイントサイト", date: "2026.07.14", thumbType: "summary", excerpt: "ポイ活記事における検索意図とは何かを整理し、比較系・使い方系・注意点系というキーワードそれぞれの特徴の違いを踏まえながら、実際の記事の見出し構成にどう落とし込むかを具体例つきでわかりやすく解説します。" },
    { title: "ポイ活サイトのカテゴリ設計!読者が迷わない記事分類の作り方", url: "/pages/articles/poikatsu-site-category-sekkei.html", category: "ポイントサイト", date: "2026.07.14", thumbType: "summary", excerpt: "ポイ活サイトにおけるカテゴリ設計の役割から、ポイント種類・利用シーンでの分け方、初心者導線の作り方、増えすぎたカテゴリの整理方法まで、読者が迷わないサイト内の記事分類の作り方を具体的に詳しく解説します。" },
    { title: "ポイ活記事の内部リンク設計!初心者記事から個別記事へつなぐ方法", url: "/pages/articles/poikatsu-kiji-naibu-link-sekkei.html", category: "ポイントサイト", date: "2026.07.14", thumbType: "summary", excerpt: "ポイ活記事における内部リンクの目的や関連記事を選ぶ基準、初心者記事への導線の作り方、比較記事から個別記事への流れ、リンクを貼りすぎない注意点まで、サイト運営初心者向けに具体例を交えてわかりやすく解説します。" },
    { title: "ポイ活サイトの更新運用!古いキャンペーン情報を残さない管理方法", url: "/pages/articles/poikatsu-site-koushin-unyou.html", category: "ポイントサイト", date: "2026.07.14", thumbType: "caution", excerpt: "ポイ活サイトで更新が必要な理由や確認すべき情報の種類、更新日の管理方法、終了したキャンペーン情報の扱い方、定期チェックのルールまで、古い情報を残さないための更新運用の考え方を具体的にわかりやすく解説します。" },
    { title: "比較記事と個別記事の役割分担!ポイ活サイトの記事設計を整える", url: "/pages/articles/hikaku-kobetsu-kiji-yakuwari.html", category: "ポイントサイト", date: "2026.07.14", thumbType: "compare", excerpt: "ポイ活サイトにおける比較記事と個別記事それぞれの役割の違いや重複を避ける構成、読者の次の行動の考え方、内部リンクでのつなぎ方まで、記事設計の整え方をサイト運営初心者向けに具体例つきで詳しく解説します。" },
    { title: "アフィリエイトリンクを自然に貼る方法!ポイ活記事で信頼を落とさない導線", url: "/pages/articles/affiliate-link-shizen.html", category: "ポイントサイト", date: "2026.07.14", thumbType: "caution", excerpt: "ポイ活情報サイトでアフィリエイトリンクを自然に貼るために、リンクを貼る位置の考え方や過度な誘導を避ける理由、公式情報へのリンクの用意、比較表との組み合わせ方、読者目線での導線作りをわかりやすく解説します。" },
    { title: "ポイ活レビュー記事の書き方!体験談を誇張せずに伝える構成", url: "/pages/articles/poikatsu-review-kiji-kakikata.html", category: "ポイントサイト", date: "2026.07.14", thumbType: "summary", excerpt: "ポイ活のレビュー記事を書く際に、体験談を誇張せず伝えるためのレビュー記事の目的や体験した範囲の明確化、メリットと注意点のバランス、古い情報の更新方法、読者に判断材料を渡す書き方までわかりやすく解説します。" },
    { title: "公式情報を引用する時のポイント!ポイ活記事で誤情報を防ぐ方法", url: "/pages/articles/koushiki-jouhou-inyou-point.html", category: "ポイントサイト", date: "2026.07.14", thumbType: "caution", excerpt: "ポイ活記事で誤情報を防ぐために、公式情報を優先する理由や引用する箇所の選び方、引用しすぎない注意点、更新日をこまめに確認する習慣、読者に確認を促す書き方のポイントまでわかりやすく解説します。" },
    { title: "終了したキャンペーン記事のリライト方法!削除・更新・統合の判断基準", url: "/pages/articles/shuuryou-campaign-kiji-rewrite.html", category: "ポイントサイト", date: "2026.07.14", thumbType: "caution", excerpt: "終了したキャンペーン記事を上手にリライトするために、記事を放置するリスクや更新で残せるケース、削除を検討するケース、まとめ記事へ統合する方法、読者に分かりやすい表示の工夫までわかりやすく解説します。" },
    { title: "ポイ活記事のCTA文言の作り方!押しつけ感のない案内表現", url: "/pages/articles/poikatsu-kiji-cta-tsukurikata.html", category: "ポイントサイト", date: "2026.07.14", thumbType: "summary", excerpt: "ポイ活記事のCTA文言を作る際に、CTAが持つ役割や強すぎる表現を避ける理由、確認行動を促す書き方、注意点も添える理由、記事タイプ別のCTA例まで押しつけ感のない案内表現をわかりやすく丁寧に解説します。" },
    { title: "ポイ活サイトの読者ペルソナ設計!初心者・主婦・会社員で変わる構成", url: "/pages/articles/poikatsu-site-persona-sekkei.html", category: "ポイントサイト", date: "2026.07.14", thumbType: "summary", excerpt: "ポイ活サイトの読者ペルソナ設計として、ペルソナを決める理由や初心者向けの悩み、主婦・主夫向けの悩み、会社員向けの悩みの違いを踏まえた、記事構成への反映方法までわかりやすく解説します。" },
    { title: "ポイント制度変更に強い記事の作り方!改定・終了に備える書き方", url: "/pages/articles/point-seido-henkou-tsuyoi-kiji.html", category: "ポイントサイト", date: "2026.07.14", thumbType: "caution", excerpt: "ポイント制度の改定や終了に備えるために、制度変更が起きやすい理由や断定しすぎない表現、確認先を明記する方法、更新しやすい構成、古くなった情報の直し方をわかりやすく解説します。" },
    { title: "ポイ活記事のサムネイル設計!クリックされやすく誤解されにくい作り方", url: "/pages/articles/poikatsu-kiji-thumbnail-sekkei.html", category: "ポイントサイト", date: "2026.07.14", thumbType: "summary", excerpt: "ポイ活記事のサムネイル設計として、サムネイルが持つ役割や入れるべき情報、煽りすぎないデザインの考え方、比較記事向けの見せ方、画像を更新する際の管理方法までわかりやすく解説します。" },
    { title: "ポイ活記事にFAQを入れるメリット!読者の不安を解消する構成術", url: "/pages/articles/poikatsu-kiji-faq-merit.html", category: "ポイントサイト", date: "2026.07.14", thumbType: "summary", excerpt: "ポイ活記事にFAQを入れるメリットとして、FAQが果たす役割やよくある疑問の集め方、本文との重複を避ける工夫、短く答えるコツ、内部リンクへつなげる方法までわかりやすく解説します。" },
