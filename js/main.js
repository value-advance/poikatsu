...
(function () {
  ...
  const ARTICLE_SEARCH_INDEX = [
    ...
    { title: "Apple Payでポイ活する方法!登録カードとタッチ決済の使い分け", url: "/pages/articles/apple-pay-poikatsu", category: "クレジットカード", date: "2026.09.06", thumbType: "creditcard", excerpt: "Apple Pay自体にはポイント制度がなく、実際のポイントは登録したカードで決まる仕組みを解説。iD・QUICPay・タッチ決済の違い、レジでの選び方、Suicaとの混同に注意する点も紹介します。" },
