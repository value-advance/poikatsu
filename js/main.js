...
(function () {
  ...
  const ARTICLE_SEARCH_INDEX = [
    ...
    { title: "引越し後の生活用品で使えるポイ活術!支出が増える前に確認したい節約ポイント", url: "/pages/articles/hikkoshi-seikatsuyohin-poikatsu", category: "ショッピング", date: "2026.08.28", thumbType: "caution", excerpt: "支出が増えやすい理由、ポイント還元日の確認、クーポンと支払い方法の組み合わせ、買いすぎを防ぐ注意点を解説します。" },
