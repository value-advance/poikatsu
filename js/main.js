...
(function () {
  ...
  const ARTICLE_SEARCH_INDEX = [
    ...
    { title: "マツキヨココカラのポイント制度!マツキヨココカラポイントとdポイントの関係", url: "/pages/articles/matsukiyo-cocokara-point", category: "ショッピング", date: "2026.08.26", thumbType: "compare", excerpt: "現金払いとクレジット払いでの違い、dポイントとの併用条件を解説します。" },
    ...
    { title: "dポイントが反映されない原因は?付与時期と対象条件を確認しよう", url: "/pages/articles/dpoint-hanei-sarenai", category: "ショッピング", date: "2026.08.11", thumbType: "caution", excerpt: "付与時期のズレやカード提示忘れ、対象外商品・サービス、dポイントマーケットなど反映されない原因を解説します。" },
    ...
    { title: "ポイントミュージアムとは?安全性・交換条件・特徴をわかりやすく解説", url: "/pages/articles/point-museum-poikatsu", category: "ポイントサイト", date: "2026.08.11", thumbType: "earnings", excerpt: "ポイントミュージアムの運営会社や安全性、メール受信・クリックで貯める仕組み、交換方法、登録方法までわかりやすく解説します。" },
