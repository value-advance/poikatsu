...
(function () {
  ...
  const ARTICLE_SEARCH_INDEX = [
    ...
    { title: "Apple Payでポイ活する方法!ポイント還元とiD・QUICPay・タッチ決済の違い", url: "/pages/articles/apple-pay-poikatsu", category: "クレジットカード", date: "2026.09.07", thumbType: "creditcard", excerpt: "Apple Pay自体にはポイント制度がなく、実際のポイントは登録したカードで決まる仕組みを解説。iD・QUICPay・タッチ決済の違い、レジでの選び方、Suicaとの混同に注意する点も紹介します。" },
    { title: "保険相談案件のポイ活とは?面談前に知っておきたいメリットと注意点", url: "/pages/articles/hoken-soudan-anken-poikatsu", category: "ポイントサイト", date: "2026.09.07", thumbType: "caution", excerpt: "保険相談案件のポイ活について、対象になる条件や面談実施・アンケート回答などの成果条件の違い、却下されやすいケース、面談前後に確認したいことを初心者向けに解説します。" },
    { title: "楽天銀行ハッピープログラムの基本!銀行取引で楽天ポイントを貯める方法", url: "/pages/articles/rakuten-ginkou-happy-program", category: "口座開設", date: "2026.09.07", thumbType: "summary", excerpt: "楽天銀行「ハッピープログラム」の仕組みを解説。給与受取・口座振替などポイント対象取引、会員ステージの判定条件、マネーブリッジとの違いを公式情報にもとづいて紹介します。" },
