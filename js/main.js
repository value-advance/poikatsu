...
(function () {
  ...
  const ARTICLE_SEARCH_INDEX = [
    ...
    { title: "PayPayポイントが付かない原因は?確認すべき条件と対策", url: "/pages/articles/paypay-point-tsukanai", category: "ショッピング", date: "2026.07.10", thumbType: "caution", excerpt: "PayPayポイントが付かないときに考えられる原因と、確認すべき条件を解説します。" },
    ...
    { title: "dポイントが反映されない原因は?付与時期と対象条件を確認しよう", url: "/pages/articles/dpoint-hanei-sarenai", category: "ショッピング", date: "2026.07.10", thumbType: "caution", excerpt: "付与時期のズレやカード提示忘れ、対象外商品・サービスなど反映されない原因を解説します。" },
    ...
    { title: "クレジットカードを作りすぎると危険?ポイ活で注意したい信用情報の基本", url: "/pages/articles/creditcard-tsukurisugi-chuui", category: "クレジットカード", date: "2026.07.10", thumbType: "caution", excerpt: "カード枚数が増えるデメリットや申し込み頻度の注意点、安全なポイ活の考え方を解説します。" },
    ...
    { title: "ふるさと納税でポイ活はできる?ポイント還元と注意点をわかりやすく解説", url: "/pages/articles/furusato-nozei-poikatsu", category: "ショッピング", date: "2026.07.11", thumbType: "caution", excerpt: "ふるさと納税の基本やポイント還元の考え方、控除上限額の確認を解説します。" },
    ...
    { title: "ポイントが付かない原因まとめ!問い合わせ前に確認すべきこと", url: "/pages/articles/point-tsukanai-genin", category: "ショッピング", date: "2026.07.11", thumbType: "caution", excerpt: "付与時期の確認や対象外商品・店舗、証拠を残す方法を解説します。" },
    ...
    { title: "宿泊予約サイトでポイントを取りこぼさない方法!予約前の比較ポイント", url: "/pages/articles/shukuhaku-yoyaku-point", category: "ショッピング", date: "2026.07.12", thumbType: "compare", excerpt: "予約サイトごとのポイントの違いや公式サイト予約との比較、クーポン併用の確認、キャンセル時のポイント注意、旅行後に確認することを解説します。" },
    ...
    { title: "家電量販店のポイントを賢く使う方法!現金値引きとの違いを解説", url: "/pages/articles/kadenryohanten-point", category: "ショッピング", date: "2026.07.12", thumbType: "compare", excerpt: "家電量販店ポイントの特徴やポイント還元と値引きの違い、大型家電で注意したいこと、保証・配送費との比較、次回購入に残すか使うかの判断について解説します。" },
    ...
    { title: "ユニクロ・GUでポイントは貯まる?衣類購入でできる節約チェック", url: "/pages/articles/uniqlo-gu-point", category: "ショッピング", date: "2026.07.12", thumbType: "beginner", excerpt: "衣類購入で見るべきポイントや公式アプリの役割、キャッシュレス決済との組み合わせ、セール時の買い方、買いすぎを防ぐルールについて解説します。" },
    ...
    { title: "ネットスーパーでポイ活する方法!送料・配達枠・ポイントの確認術", url: "/pages/articles/net-super-poikatsu", category: "ショッピング", date: "2026.07.12", thumbType: "beginner", excerpt: "ネットスーパーのメリットや送料・最低注文金額の確認、ポイント還元の見方、店舗受け取りの活用、買い忘れを減らすコツをやさしく解説します。" },
    ...
    { title: "引っ越しでポイ活する方法!見積もり・家具購入・手続きの確認ポイント", url: "/pages/articles/hikkoshi-poikatsu", category: "ショッピング", date: "2026.07.12", thumbType: "summary", excerpt: "引っ越しで発生する出費、見積もり比較時の注意、家具家電購入のタイミング、住所変更で忘れがちなこと、無駄な契約を増やさないコツを解説します。" },
    ...
    { title: "楽天ポイントの使い方|そのまま使う・連携する・交換する完全ガイド", url: "/pages/articles/rakuten-point-tsukaikata", category: "ショッピング", date: "2026.08.09", thumbType: "summary", excerpt: "楽天ポイントの使い方を徹底解説。街のお店やネットでそのまま使う方法、アカウント連携で使えるサービス、ANAマイル・楽天Edyへの交換方法を紹介します。" },
